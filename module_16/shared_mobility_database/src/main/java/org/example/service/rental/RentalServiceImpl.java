...
import org.example.repository.rental.RentalDaoSQL;
...
public class RentalServiceImpl implements RentalService {
    ...
    public RentalServiceImpl() {
        rentalRepository = new RentalDaoSQL();
    ...
    @Override
    public void start(UUID userId, UUID vehicleId) throws GenericException, SQLException {
    ...
    @Override
    public void end(UUID rentalId) throws GenericException, SQLException {
    ...
    public boolean isDrivingLicenseValid(DrivingLicense drivingLicense, Vehicle vehicle) throws SQLException {
